  ...
  <div class="container d-flex flex-column" style="background-color: transparent">
    <div>
      ...
      <div class="input-group mb-3 shadow-sm">
        <input
          v-model="harbourSearchValue"
          type="text"
          class="form-control dropdown-toggle border-0"
        ...
        <ul class="dropdown-menu" style="z-index: 10000">
          <li
            v-for="harbour in filterHarbours()"
            class="dropdown-item"
            :key="harbour.harbourId"
    ...
    <div class="flex-fill position-relative border-white shadow-sm">
      <l-map ref="map" :zoom="7" :center="[58.90540407714214, 24.440707020436466]">
        <l-tile-layer
...
export default {
  ...
  computed: {
    selectedLatLng() {
      return this.selectedHarbour
        ? latLng(this.selectedHarbour.locationLongitude, this.selectedHarbour.locationLatitude)
        : latLng(0, 0)
    },
  },
  methods: {
    ...
    filterHarbours() {
      return this.harboursMainInfo.filter((harbour) =>
        harbour.harbourName.toLowerCase().includes(this.harbourSearchValue.toLowerCase()),
      )
    },
